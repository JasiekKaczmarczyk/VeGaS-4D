...
def slice_4d_vegas(scale, r1, r2, scaling_factor: torch.Tensor):
    scaling_factor_expanded = scaling_factor[:, None].repeat(1, 3)
    scaling_factor_expanded = torch.cat([scaling_factor_expanded, torch.ones_like(scaling_factor[:, None])], dim=-1)

    scale = scale * scaling_factor_expanded
    ...
    cov_3d_out0 = sigma[:, 0, 0]
    cov_3d_out1 = sigma[:, 0, 1]
    cov_3d_out2 = sigma[:, 0, 2]
    cov_3d_out3 = sigma[:, 1, 1]
    cov_3d_out4 = sigma[:, 1, 2]
    cov_3d_out5 = sigma[:, 2, 2]
    cov_3d_out = torch.stack([cov_3d_out0, cov_3d_out1, cov_3d_out2, cov_3d_out3, cov_3d_out4, cov_3d_out5], dim=-1)
...
def slice_4d_vegas_v2(scale, r1, r2, scaling_factor: torch.Tensor):
    scaling_factor_expanded = scaling_factor[:, None].repeat(1, 3)
    scaling_factor_expanded = torch.cat([scaling_factor_expanded, torch.ones_like(scaling_factor[:, None])], dim=-1)
